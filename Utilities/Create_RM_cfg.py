...
def parseOptions():
    ...
    thePattuplizer="PatTuplizer_44X_src.py"
    theJson="Cert_160404-180252_7TeV_ReRecoNov08_Collisions11_JSON_v2.txt"
    theLumiCalc="lumiCheck_Legacy.txt"
    theRunPeriod="2012A"
    theDir="mc/53X/HCP_Corr_10.13/"
    ...
    parser.add_option('-t', '--tag',      dest='appendName', type='string', default="7TeV", help='Tag that will be appended to the file/dir names.')
    ...
    if (opt.runPeriod != 'JanA_Jul1' and opt.runPeriod != 'JanA_Jul2' and opt.runPeriod != 'JanA_Aug' and opt.runPeriod != 'JanA_Oct' and opt.runPeriod != 'JanB' and opt.runPeriod != 'Custom' and opt.runPeriod != '2012A' and opt.runPeriod != '2012B' and opt.runPeriod != '2012Cv1' and opt.runPeriod != 'Aug24' and opt.runPeriod != '2012Cv2' and opt.runPeriod != 'ECAL' and opt.runPeriod != 'Jun08'):
